...
<div
	class="flex flex-col border-white/10 border-0 border-t-0 dark:bg-zinc-800/10 scrollbar-none overflow-y-scroll max-h-40">
...
<div class="block text-sm dark:text-zinc-400 w-full mt-2 ">
	{#each selected as item}
		<button
			class="flex justify-start items-center w-full h-8 text-left px-3 border-b border-white/10 last:border-transparent">
